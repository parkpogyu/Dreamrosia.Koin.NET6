namespace Dreamrosia.Koin.Shared.Constants.Application
{
    public static class ApplicationConstants
    {
        ...
        public static class SynchronizeSignalR
        {
            public const string HubUrl = "/SynchronizeHub";
            public const string ReceiveTicker = "ReceiveTicker";
            public const string ReceivePositions = "ReceivePositions";
        }
        ...
        public static class Cache
        {
            ...
            public const string GetAllSymbolsCacheKey = "all-symbols";
            public const string GetAllCrixesCacheKey = "all-crixes";
