...
namespace Dreamrosia.Koin.Shared.Services
{
    public class ExcelService : IExcelService
    {
        private readonly IStringLocalizer<SharedLocalizerResources> _localizer;

        public ExcelService(IStringLocalizer<SharedLocalizerResources> localizer)
        {
                                              ...
                                              string sheetName = "Sheet1")
        {
            ...
            p.Workbook.Properties.Author = "Dreamrosia";
            ...
            // System.Drawing.Common is not supported on this platform. WASM
